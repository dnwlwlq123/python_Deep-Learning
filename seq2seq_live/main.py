...
def train_integer_sequence(
    ...
    print(
        f'Best model validation loss: {valid_loss:.4f}, validation acc: {valid_acc:.4f}, train loss: {train_loss:.4f}, train acc: {train_acc:.4f}')
    ...
    print('Input sequence:',
          [vocab.index2word[idx] for idx in example_input if idx not in range(len(Vocabulary.SPECIAL_TOKENS))])
    print('Target sequence:',
          [vocab.index2word[idx] for idx in example_target if idx not in range(len(Vocabulary.SPECIAL_TOKENS))])
